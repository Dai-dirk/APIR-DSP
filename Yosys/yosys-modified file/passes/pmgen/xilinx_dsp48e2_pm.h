// Generated by pmgen.py from passes/pmgen/xilinx_dsp48e2.pmg
...
struct xilinx_dsp48e2_pm {
  ...
  void setup(const vector<Cell*> &cells) {
    ...
    for (auto cell : cells) {
      ...
      do {
        ...
        std::get<0>(value) = cell;
        if (!(postAdd->type.in(id_d___add_flag))) continue;
  ...
  // passes/pmgen/xilinx_dsp48e2.pmg:69
  ...
  // passes/pmgen/xilinx_dsp48e2.pmg:73
...
rollback_label:
  ...
  // passes/pmgen/xilinx_dsp48e2.pmg:113
...
rollback_label:
  ...
  // passes/pmgen/xilinx_dsp48e2.pmg:127
  ...
  // passes/pmgen/xilinx_dsp48e2.pmg:148
...
rollback_label:
  ...
  // passes/pmgen/xilinx_dsp48e2.pmg:165
...
#define subpattern(pattern_name) do { block_subpattern_xilinx_dsp48e2_pack_ ## pattern_name (recursion+1); if (rollback) goto rollback_label; } while(0)
    ...
    if (ffA2) {
      ...
      if (dff) {
        ...
        if (dff->type.in(id_d_adff, id_d_adffe)) {
          if (param(dff, id_b_ARST_POLARITY) != param(ffA2, id_b_ARST_POLARITY))
            goto ffA1_end;
          if (port(dff, id_b_ARST) != port(ffA2, id_b_ARST))
            goto ffA1_end;
        }
        if (dff->type.in(id_d_adffe)) {
          if (param(dff, id_b_EN_POLARITY) != param(ffA2, id_b_EN_POLARITY))
            goto ffA1_end;
          if (port(dff, id_b_EN) != port(ffA2, id_b_EN))
            goto ffA1_end;
...
rollback_label:
  ...
  // passes/pmgen/xilinx_dsp48e2.pmg:229
            ...
            if (dff->type.in(id_d_dffe, id_d_sdffe, id_d_sdffce)) {
              ...
              if (port(dff, id_b_EN) != port(ffB2, id_b_EN))
                goto ffB1_end;
                                          ...
                                          if (dff->type.in(id_d_adff, id_d_adffe)) {
              if (param(dff, id_b_ARST_POLARITY) != param(ffB2, id_b_ARST_POLARITY))
                goto ffB1_end;
              if (port(dff, id_b_ARST) != port(ffB2, id_b_ARST))
                goto ffB1_end;
            }
            if (dff->type.in(id_d_adffe)) {
              if (param(dff, id_b_EN_POLARITY) != param(ffB2, id_b_EN_POLARITY))
...
rollback_label:
  ...
  // passes/pmgen/xilinx_dsp48e2.pmg:283
...
rollback_label:
  ...
  // passes/pmgen/xilinx_dsp48e2.pmg:296
...
rollback_label:
  ...
  // passes/pmgen/xilinx_dsp48e2.pmg:314
  void block_9(int recursion YS_MAYBE_UNUSED) {
    ...
    if (cells_ptr != index_9.end()) {
      ...
      for (int _pmg_idx = 0; _pmg_idx < GetSize(cells); _pmg_idx++) {
        ...
        if (!(param(postAdd, id_b_PACK).is_fully_zero())) continue;
  ...
  // passes/pmgen/xilinx_dsp48e2.pmg:333
...
rollback_label:
  ...
  // passes/pmgen/xilinx_dsp48e2.pmg:341
...
rollback_label:
  ...
  // passes/pmgen/xilinx_dsp48e2.pmg:368
  ...
  // passes/pmgen/xilinx_dsp48e2.pmg:380
...
rollback_label:
  ...
  // passes/pmgen/xilinx_dsp48e2.pmg:390
  ...
  // passes/pmgen/xilinx_dsp48e2.pmg:402
...
rollback_label:
  ...
  // passes/pmgen/xilinx_dsp48e2.pmg:413
...
rollback_label:
  ...
  // passes/pmgen/xilinx_dsp48e2.pmg:434
  ...
  // passes/pmgen/xilinx_dsp48e2.pmg:452
...
rollback_label:
  ...
  // passes/pmgen/xilinx_dsp48e2.pmg:479
...
rollback_label:
  ...
  // passes/pmgen/xilinx_dsp48e2.pmg:487
  ...
  // passes/pmgen/xilinx_dsp48e2.pmg:502
