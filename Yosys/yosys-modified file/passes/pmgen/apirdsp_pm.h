// Generated by pmgen.py from apirdsp.pmg
...
struct apirdsp_pm {
  ...
  apirdsp_pm(Module *module, const vector<Cell*> &cells) :
      module(module), sigmap(module), setup_done(false), generate_mode(false), rngseed(12345678) {
    setup(cells);
  }

  apirdsp_pm(Module *module) :
      module(module), sigmap(module), setup_done(false), generate_mode(false), rngseed(12345678) {
  }

  void setup(const vector<Cell*> &cells) {
    ud_apirdsp_pack.dff = nullptr;
    ud_apirdsp_pack.dffD = SigSpec();
    ud_apirdsp_pack.dffQ = SigSpec();
    ud_apirdsp_pack.dffclock = SigBit();
    ...
    for (auto cell : cells) {
      do {
        ...
        if (!(dsp->type.in(id_b_apirdsp))) continue;
  ...
  int run_apirdsp_pack(std::function<void()> on_accept_f) {
    log_assert(setup_done);
    accept_cnt = 0;
    on_accept = on_accept_f;
    rollback = 0;
    st_apirdsp_pack.argD = SigSpec();
    st_apirdsp_pack.argQ = SigSpec();
    st_apirdsp_pack.clock = SigBit();
    st_apirdsp_pack.dsp = nullptr;
    st_apirdsp_pack.ff = nullptr;
    st_apirdsp_pack.ffA1 = nullptr;
    st_apirdsp_pack.ffA2 = nullptr;
    st_apirdsp_pack.ffAD = nullptr;
    st_apirdsp_pack.ffB1 = nullptr;
    st_apirdsp_pack.ffB2 = nullptr;
    st_apirdsp_pack.ffD = nullptr;
    st_apirdsp_pack.ffM = nullptr;
    st_apirdsp_pack.ffP = nullptr;
    st_apirdsp_pack.overflow = nullptr;
    st_apirdsp_pack.postAdd = nullptr;
    st_apirdsp_pack.postAddAB = IdString();
    st_apirdsp_pack.postAddMux = nullptr;
    st_apirdsp_pack.postAddMuxAB = IdString();
    st_apirdsp_pack.preAdd = nullptr;
    st_apirdsp_pack.sigA = SigSpec();
    st_apirdsp_pack.sigB = SigSpec();
    st_apirdsp_pack.sigC = SigSpec();
    st_apirdsp_pack.sigD = SigSpec();
    st_apirdsp_pack.sigM = SigSpec();
    st_apirdsp_pack.sigP = SigSpec();
    block_0(1);
    log_assert(rollback_cache.empty());
    return accept_cnt;
  }

  int run_apirdsp_pack(std::function<void(apirdsp_pm&)> on_accept_f) {
    return run_apirdsp_pack([&](){on_accept_f(*this);});
  }

  int run_apirdsp_pack() {
    return run_apirdsp_pack([](){});
  }

  void block_subpattern_apirdsp_pack_(int recursion) { block_0(recursion); }
  void block_subpattern_apirdsp_pack_in_dffe(int recursion) { block_17(recursion); }
  void block_subpattern_apirdsp_pack_out_dffe(int recursion) { block_21(recursion); }

  // apirdsp.pmg:69
  void block_0(int recursion YS_MAYBE_UNUSED) {
    Cell* &dsp YS_MAYBE_UNUSED = st_apirdsp_pack.dsp;
    Cell* &dff YS_MAYBE_UNUSED = ud_apirdsp_pack.dff;
    SigSpec &dffD YS_MAYBE_UNUSED = ud_apirdsp_pack.dffD;
    SigSpec &dffQ YS_MAYBE_UNUSED = ud_apirdsp_pack.dffQ;
    SigBit &dffclock YS_MAYBE_UNUSED = ud_apirdsp_pack.dffclock;
  ...
  void block_1(int recursion YS_MAYBE_UNUSED) {
    Cell* const &dsp YS_MAYBE_UNUSED = st_apirdsp_pack.dsp;
    SigBit &clock YS_MAYBE_UNUSED = st_apirdsp_pack.clock;
    SigSpec &sigA YS_MAYBE_UNUSED = st_apirdsp_pack.sigA;
    SigSpec &sigB YS_MAYBE_UNUSED = st_apirdsp_pack.sigB;
    SigSpec &sigC YS_MAYBE_UNUSED = st_apirdsp_pack.sigC;
    SigSpec &sigD YS_MAYBE_UNUSED = st_apirdsp_pack.sigD;
    SigSpec &sigM YS_MAYBE_UNUSED = st_apirdsp_pack.sigM;
    Cell* &dff YS_MAYBE_UNUSED = ud_apirdsp_pack.dff;
    SigSpec &dffD YS_MAYBE_UNUSED = ud_apirdsp_pack.dffD;
    SigSpec &dffQ YS_MAYBE_UNUSED = ud_apirdsp_pack.dffQ;
    SigBit &dffclock YS_MAYBE_UNUSED = ud_apirdsp_pack.dffclock;
...
#define subpattern(pattern_name) do { block_subpattern_apirdsp_pack_ ## pattern_name (recursion+1); if (rollback) goto rollback_label; } while(0)
...
rollback_label:
  ...
  void block_2(int recursion YS_MAYBE_UNUSED) {
    Cell* const &dsp YS_MAYBE_UNUSED = st_apirdsp_pack.dsp;
    const SigSpec &sigB YS_MAYBE_UNUSED = st_apirdsp_pack.sigB;
    const SigSpec &sigC YS_MAYBE_UNUSED = st_apirdsp_pack.sigC;
    const SigSpec &sigD YS_MAYBE_UNUSED = st_apirdsp_pack.sigD;
    const SigSpec &sigM YS_MAYBE_UNUSED = st_apirdsp_pack.sigM;
    SigSpec &argQ YS_MAYBE_UNUSED = st_apirdsp_pack.argQ;
    SigBit &clock YS_MAYBE_UNUSED = st_apirdsp_pack.clock;
    Cell* &ffAD YS_MAYBE_UNUSED = st_apirdsp_pack.ffAD;
    SigSpec &sigA YS_MAYBE_UNUSED = st_apirdsp_pack.sigA;
    Cell* &dff YS_MAYBE_UNUSED = ud_apirdsp_pack.dff;
    SigSpec &dffD YS_MAYBE_UNUSED = ud_apirdsp_pack.dffD;
    SigSpec &dffQ YS_MAYBE_UNUSED = ud_apirdsp_pack.dffQ;
...
rollback_label:
  ...
  void block_3(int recursion YS_MAYBE_UNUSED) {
    const SigSpec &argQ YS_MAYBE_UNUSED = st_apirdsp_pack.argQ;
    const SigBit &clock YS_MAYBE_UNUSED = st_apirdsp_pack.clock;
    Cell* const &dsp YS_MAYBE_UNUSED = st_apirdsp_pack.dsp;
    Cell* const &ffAD YS_MAYBE_UNUSED = st_apirdsp_pack.ffAD;
    const SigSpec &sigA YS_MAYBE_UNUSED = st_apirdsp_pack.sigA;
    const SigSpec &sigB YS_MAYBE_UNUSED = st_apirdsp_pack.sigB;
    const SigSpec &sigC YS_MAYBE_UNUSED = st_apirdsp_pack.sigC;
    const SigSpec &sigD YS_MAYBE_UNUSED = st_apirdsp_pack.sigD;
    const SigSpec &sigM YS_MAYBE_UNUSED = st_apirdsp_pack.sigM;
    Cell* &preAdd YS_MAYBE_UNUSED = st_apirdsp_pack.preAdd;
    Cell* &dff YS_MAYBE_UNUSED = ud_apirdsp_pack.dff;
    SigSpec &dffD YS_MAYBE_UNUSED = ud_apirdsp_pack.dffD;
    SigSpec &dffQ YS_MAYBE_UNUSED = ud_apirdsp_pack.dffQ;
    SigBit &dffclock YS_MAYBE_UNUSED = ud_apirdsp_pack.dffclock;
  ...
  void block_4(int recursion YS_MAYBE_UNUSED) {
    ...
    Cell* const &dsp YS_MAYBE_UNUSED = st_apirdsp_pack.dsp;
    Cell* const &ffAD YS_MAYBE_UNUSED = st_apirdsp_pack.ffAD;
    Cell* const &preAdd YS_MAYBE_UNUSED = st_apirdsp_pack.preAdd;
    const SigSpec &sigC YS_MAYBE_UNUSED = st_apirdsp_pack.sigC;
    const SigSpec &sigM YS_MAYBE_UNUSED = st_apirdsp_pack.sigM;
    SigSpec &sigA YS_MAYBE_UNUSED = st_apirdsp_pack.sigA;
    SigSpec &sigB YS_MAYBE_UNUSED = st_apirdsp_pack.sigB;
...
rollback_label:
  ...
  void block_5(int recursion YS_MAYBE_UNUSED) {
    ...
    SigSpec &argQ YS_MAYBE_UNUSED = st_apirdsp_pack.argQ;
    SigBit &clock YS_MAYBE_UNUSED = st_apirdsp_pack.clock;
    Cell* &ffA1 YS_MAYBE_UNUSED = st_apirdsp_pack.ffA1;
    Cell* &ffA2 YS_MAYBE_UNUSED = st_apirdsp_pack.ffA2;
    Cell* &ffAD YS_MAYBE_UNUSED = st_apirdsp_pack.ffAD;
    SigSpec &sigA YS_MAYBE_UNUSED = st_apirdsp_pack.sigA;
    Cell* &dff YS_MAYBE_UNUSED = ud_apirdsp_pack.dff;
    SigSpec &dffD YS_MAYBE_UNUSED = ud_apirdsp_pack.dffD;
...
rollback_label:
  ...
  void block_6(int recursion YS_MAYBE_UNUSED) {
    Cell* const &dsp YS_MAYBE_UNUSED = st_apirdsp_pack.dsp;
    Cell* const &ffA1 YS_MAYBE_UNUSED = st_apirdsp_pack.ffA1;
    Cell* const &ffA2 YS_MAYBE_UNUSED = st_apirdsp_pack.ffA2;
    Cell* const &ffAD YS_MAYBE_UNUSED = st_apirdsp_pack.ffAD;
    Cell* const &preAdd YS_MAYBE_UNUSED = st_apirdsp_pack.preAdd;
    const SigSpec &sigA YS_MAYBE_UNUSED = st_apirdsp_pack.sigA;
    const SigSpec &sigC YS_MAYBE_UNUSED = st_apirdsp_pack.sigC;
    ...
    SigSpec &argQ YS_MAYBE_UNUSED = st_apirdsp_pack.argQ;
    SigBit &clock YS_MAYBE_UNUSED = st_apirdsp_pack.clock;
    Cell* &ffB1 YS_MAYBE_UNUSED = st_apirdsp_pack.ffB1;
    Cell* &ffB2 YS_MAYBE_UNUSED = st_apirdsp_pack.ffB2;
    SigSpec &sigB YS_MAYBE_UNUSED = st_apirdsp_pack.sigB;
    Cell* &dff YS_MAYBE_UNUSED = ud_apirdsp_pack.dff;
    SigSpec &dffD YS_MAYBE_UNUSED = ud_apirdsp_pack.dffD;
    SigSpec &dffQ YS_MAYBE_UNUSED = ud_apirdsp_pack.dffQ;
...
rollback_label:
  ...
  void block_7(int recursion YS_MAYBE_UNUSED) {
    ...
    Cell* const &ffA2 YS_MAYBE_UNUSED = st_apirdsp_pack.ffA2;
    Cell* const &ffAD YS_MAYBE_UNUSED = st_apirdsp_pack.ffAD;
    Cell* const &ffB1 YS_MAYBE_UNUSED = st_apirdsp_pack.ffB1;
    Cell* const &ffB2 YS_MAYBE_UNUSED = st_apirdsp_pack.ffB2;
    Cell* const &preAdd YS_MAYBE_UNUSED = st_apirdsp_pack.preAdd;
    const SigSpec &sigA YS_MAYBE_UNUSED = st_apirdsp_pack.sigA;
    const SigSpec &sigB YS_MAYBE_UNUSED = st_apirdsp_pack.sigB;
    const SigSpec &sigC YS_MAYBE_UNUSED = st_apirdsp_pack.sigC;
    ...
    SigSpec &argQ YS_MAYBE_UNUSED = st_apirdsp_pack.argQ;
    SigBit &clock YS_MAYBE_UNUSED = st_apirdsp_pack.clock;
    Cell* &ffD YS_MAYBE_UNUSED = st_apirdsp_pack.ffD;
    SigSpec &sigD YS_MAYBE_UNUSED = st_apirdsp_pack.sigD;
    Cell* &dff YS_MAYBE_UNUSED = ud_apirdsp_pack.dff;
    SigSpec &dffD YS_MAYBE_UNUSED = ud_apirdsp_pack.dffD;
    SigSpec &dffQ YS_MAYBE_UNUSED = ud_apirdsp_pack.dffQ;
...
rollback_label:
  ...
  void block_8(int recursion YS_MAYBE_UNUSED) {
    ...
    Cell* const &ffB1 YS_MAYBE_UNUSED = st_apirdsp_pack.ffB1;
    Cell* const &ffB2 YS_MAYBE_UNUSED = st_apirdsp_pack.ffB2;
    Cell* const &ffD YS_MAYBE_UNUSED = st_apirdsp_pack.ffD;
    Cell* const &preAdd YS_MAYBE_UNUSED = st_apirdsp_pack.preAdd;
    const SigSpec &sigA YS_MAYBE_UNUSED = st_apirdsp_pack.sigA;
    const SigSpec &sigB YS_MAYBE_UNUSED = st_apirdsp_pack.sigB;
    const SigSpec &sigC YS_MAYBE_UNUSED = st_apirdsp_pack.sigC;
    const SigSpec &sigD YS_MAYBE_UNUSED = st_apirdsp_pack.sigD;
    SigSpec &argD YS_MAYBE_UNUSED = st_apirdsp_pack.argD;
    SigBit &clock YS_MAYBE_UNUSED = st_apirdsp_pack.clock;
    Cell* &ffM YS_MAYBE_UNUSED = st_apirdsp_pack.ffM;
    SigSpec &sigM YS_MAYBE_UNUSED = st_apirdsp_pack.sigM;
    SigSpec &sigP YS_MAYBE_UNUSED = st_apirdsp_pack.sigP;
    Cell* &dff YS_MAYBE_UNUSED = ud_apirdsp_pack.dff;
    SigSpec &dffD YS_MAYBE_UNUSED = ud_apirdsp_pack.dffD;
    SigSpec &dffQ YS_MAYBE_UNUSED = ud_apirdsp_pack.dffQ;
    SigBit &dffclock YS_MAYBE_UNUSED = ud_apirdsp_pack.dffclock;
...
rollback_label:
  ...
  void block_9(int recursion YS_MAYBE_UNUSED) {
    const SigSpec &argD YS_MAYBE_UNUSED = st_apirdsp_pack.argD;
    const SigSpec &argQ YS_MAYBE_UNUSED = st_apirdsp_pack.argQ;
    const SigBit &clock YS_MAYBE_UNUSED = st_apirdsp_pack.clock;
    Cell* const &dsp YS_MAYBE_UNUSED = st_apirdsp_pack.dsp;
    Cell* const &ffA1 YS_MAYBE_UNUSED = st_apirdsp_pack.ffA1;
    ...
    Cell* const &ffB2 YS_MAYBE_UNUSED = st_apirdsp_pack.ffB2;
    Cell* const &ffD YS_MAYBE_UNUSED = st_apirdsp_pack.ffD;
    Cell* const &ffM YS_MAYBE_UNUSED = st_apirdsp_pack.ffM;
    Cell* const &preAdd YS_MAYBE_UNUSED = st_apirdsp_pack.preAdd;
    const SigSpec &sigA YS_MAYBE_UNUSED = st_apirdsp_pack.sigA;
    const SigSpec &sigB YS_MAYBE_UNUSED = st_apirdsp_pack.sigB;
    const SigSpec &sigC YS_MAYBE_UNUSED = st_apirdsp_pack.sigC;
    const SigSpec &sigD YS_MAYBE_UNUSED = st_apirdsp_pack.sigD;
    const SigSpec &sigM YS_MAYBE_UNUSED = st_apirdsp_pack.sigM;
    const SigSpec &sigP YS_MAYBE_UNUSED = st_apirdsp_pack.sigP;
    Cell* &postAdd YS_MAYBE_UNUSED = st_apirdsp_pack.postAdd;
    IdString &postAddAB YS_MAYBE_UNUSED = st_apirdsp_pack.postAddAB;
    Cell* &dff YS_MAYBE_UNUSED = ud_apirdsp_pack.dff;
    SigSpec &dffD YS_MAYBE_UNUSED = ud_apirdsp_pack.dffD;
    SigSpec &dffQ YS_MAYBE_UNUSED = ud_apirdsp_pack.dffQ;
    SigBit &dffclock YS_MAYBE_UNUSED = ud_apirdsp_pack.dffclock;
  ...
  void block_10(int recursion YS_MAYBE_UNUSED) {
    ...
    Cell* const &ffD YS_MAYBE_UNUSED = st_apirdsp_pack.ffD;
    Cell* const &ffM YS_MAYBE_UNUSED = st_apirdsp_pack.ffM;
    Cell* const &postAdd YS_MAYBE_UNUSED = st_apirdsp_pack.postAdd;
    const IdString &postAddAB YS_MAYBE_UNUSED = st_apirdsp_pack.postAddAB;
    Cell* const &preAdd YS_MAYBE_UNUSED = st_apirdsp_pack.preAdd;
    const SigSpec &sigA YS_MAYBE_UNUSED = st_apirdsp_pack.sigA;
    const SigSpec &sigB YS_MAYBE_UNUSED = st_apirdsp_pack.sigB;
    const SigSpec &sigD YS_MAYBE_UNUSED = st_apirdsp_pack.sigD;
...
rollback_label:
  ...
  void block_11(int recursion YS_MAYBE_UNUSED) {
    ...
    SigSpec &argD YS_MAYBE_UNUSED = st_apirdsp_pack.argD;
    SigBit &clock YS_MAYBE_UNUSED = st_apirdsp_pack.clock;
    Cell* &ffP YS_MAYBE_UNUSED = st_apirdsp_pack.ffP;
    SigSpec &sigP YS_MAYBE_UNUSED = st_apirdsp_pack.sigP;
    Cell* &dff YS_MAYBE_UNUSED = ud_apirdsp_pack.dff;
    SigSpec &dffD YS_MAYBE_UNUSED = ud_apirdsp_pack.dffD;
    SigSpec &dffQ YS_MAYBE_UNUSED = ud_apirdsp_pack.dffQ;
...
rollback_label:
  ...
  void block_12(int recursion YS_MAYBE_UNUSED) {
    ...
    Cell* const &ffD YS_MAYBE_UNUSED = st_apirdsp_pack.ffD;
    Cell* const &ffM YS_MAYBE_UNUSED = st_apirdsp_pack.ffM;
    Cell* const &ffP YS_MAYBE_UNUSED = st_apirdsp_pack.ffP;
    Cell* const &postAdd YS_MAYBE_UNUSED = st_apirdsp_pack.postAdd;
    const IdString &postAddAB YS_MAYBE_UNUSED = st_apirdsp_pack.postAddAB;
    Cell* const &preAdd YS_MAYBE_UNUSED = st_apirdsp_pack.preAdd;
    const SigSpec &sigA YS_MAYBE_UNUSED = st_apirdsp_pack.sigA;
    ...
    const SigSpec &sigM YS_MAYBE_UNUSED = st_apirdsp_pack.sigM;
    const SigSpec &sigP YS_MAYBE_UNUSED = st_apirdsp_pack.sigP;
    Cell* &postAddMux YS_MAYBE_UNUSED = st_apirdsp_pack.postAddMux;
    IdString &postAddMuxAB YS_MAYBE_UNUSED = st_apirdsp_pack.postAddMuxAB;
    Cell* &dff YS_MAYBE_UNUSED = ud_apirdsp_pack.dff;
    SigSpec &dffD YS_MAYBE_UNUSED = ud_apirdsp_pack.dffD;
    SigSpec &dffQ YS_MAYBE_UNUSED = ud_apirdsp_pack.dffQ;
    SigBit &dffclock YS_MAYBE_UNUSED = ud_apirdsp_pack.dffclock;
  ...
  void block_13(int recursion YS_MAYBE_UNUSED) {
    ...
    Cell* const &postAdd YS_MAYBE_UNUSED = st_apirdsp_pack.postAdd;
    const IdString &postAddAB YS_MAYBE_UNUSED = st_apirdsp_pack.postAddAB;
    Cell* const &postAddMux YS_MAYBE_UNUSED = st_apirdsp_pack.postAddMux;
    const IdString &postAddMuxAB YS_MAYBE_UNUSED = st_apirdsp_pack.postAddMuxAB;
    Cell* const &preAdd YS_MAYBE_UNUSED = st_apirdsp_pack.preAdd;
    const SigSpec &sigA YS_MAYBE_UNUSED = st_apirdsp_pack.sigA;
    const SigSpec &sigB YS_MAYBE_UNUSED = st_apirdsp_pack.sigB;
    const SigSpec &sigD YS_MAYBE_UNUSED = st_apirdsp_pack.sigD;
...
rollback_label:
  ...
  void block_14(int recursion YS_MAYBE_UNUSED) {
    ...
    const SigSpec &sigM YS_MAYBE_UNUSED = st_apirdsp_pack.sigM;
    const SigSpec &sigP YS_MAYBE_UNUSED = st_apirdsp_pack.sigP;
    Cell* &overflow YS_MAYBE_UNUSED = st_apirdsp_pack.overflow;
    Cell* &dff YS_MAYBE_UNUSED = ud_apirdsp_pack.dff;
    SigSpec &dffD YS_MAYBE_UNUSED = ud_apirdsp_pack.dffD;
    SigSpec &dffQ YS_MAYBE_UNUSED = ud_apirdsp_pack.dffQ;
    SigBit &dffclock YS_MAYBE_UNUSED = ud_apirdsp_pack.dffclock;
  ...
  void block_15(int recursion YS_MAYBE_UNUSED) {
    ...
    Cell* const &ffM YS_MAYBE_UNUSED = st_apirdsp_pack.ffM;
    Cell* const &ffP YS_MAYBE_UNUSED = st_apirdsp_pack.ffP;
    Cell* const &overflow YS_MAYBE_UNUSED = st_apirdsp_pack.overflow;
    Cell* const &postAdd YS_MAYBE_UNUSED = st_apirdsp_pack.postAdd;
    const IdString &postAddAB YS_MAYBE_UNUSED = st_apirdsp_pack.postAddAB;
    Cell* const &postAddMux YS_MAYBE_UNUSED = st_apirdsp_pack.postAddMux;
    const IdString &postAddMuxAB YS_MAYBE_UNUSED = st_apirdsp_pack.postAddMuxAB;
...
rollback_label:
  ...
  void block_18(int recursion YS_MAYBE_UNUSED) {
    const SigSpec &argQ YS_MAYBE_UNUSED = st_apirdsp_pack.argQ;
    const SigBit &clock YS_MAYBE_UNUSED = st_apirdsp_pack.clock;
    Cell* &ff YS_MAYBE_UNUSED = st_apirdsp_pack.ff;
    Cell* &dff YS_MAYBE_UNUSED = ud_apirdsp_pack.dff;
    SigSpec &dffD YS_MAYBE_UNUSED = ud_apirdsp_pack.dffD;
    SigSpec &dffQ YS_MAYBE_UNUSED = ud_apirdsp_pack.dffQ;
    SigBit &dffclock YS_MAYBE_UNUSED = ud_apirdsp_pack.dffclock;
  ...
  void block_19(int recursion YS_MAYBE_UNUSED) {
    const SigBit &clock YS_MAYBE_UNUSED = st_apirdsp_pack.clock;
    Cell* const &ff YS_MAYBE_UNUSED = st_apirdsp_pack.ff;
    SigSpec &argQ YS_MAYBE_UNUSED = st_apirdsp_pack.argQ;
    Cell* &dff YS_MAYBE_UNUSED = ud_apirdsp_pack.dff;
    SigSpec &dffD YS_MAYBE_UNUSED = ud_apirdsp_pack.dffD;
    SigSpec &dffQ YS_MAYBE_UNUSED = ud_apirdsp_pack.dffQ;
